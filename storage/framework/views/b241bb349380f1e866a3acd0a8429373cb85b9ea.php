            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                     ...
                     <div class="form-group">
                        <?php echo e(Form::label('name', 'Name',  ['class' => 'required'])); ?>

                        <?php echo e(Form::text('name',  Auth::user()->name, ['id'=>'name', 'class' => 'form-control', 'placeholder'=>'name'] )); ?>

                    </div>
                    <div class="form-group">
                        <?php echo e(Form::label('email', 'Email',  ['class' => 'required'])); ?>

                        <?php echo e(Form::text('email', Auth::user()->email, ['id'=>'email', 'class' => 'form-control', 'placeholder'=>'email'] )); ?>

                    </div>
                    <div class="form-group">
                        <?php echo e(Form::label('mobile_no', 'Mobile No',  ['class' => 'required'])); ?>

                        <?php echo e(Form::text('mobile_no',  Auth::user()->mobile_no, ['id'=>'mobile_no', 'class' => 'form-control', 'placeholder'=>'mobile_no'] )); ?>
...
<!--
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('city', Auth::user()->city, ['id'=>'city', 'class' => 'form-control', 'placeholder'=>'city'] )); ?>

                    </div>
                    <div class="form-group">
                        <?php echo e(Form::label('state', 'State',  ['class' => 'required'])); ?>

                        <?php echo e(Form::text('state',  Auth::user()->state, ['id'=>'state', 'class' => 'form-control', 'placeholder'=>'state'] )); ?>

                    </div>
-->                 
                         
                                <td>
                                    <a href="<?php echo e(route('myinfo.edit', ['id' => Auth::User()->id])); ?>" class="btn btn-info btn-xs"><i class="fas fa-pencil-alt title="Edit""></i> </a>
                                    <a href="<?php echo e(route('myinfo.show', ['id' => Auth::User()->id])); ?>" class="btn btn-danger btn-xs"><i class="fas fa-trash-alt" title="Delete"></i> </a>
                                </td>
