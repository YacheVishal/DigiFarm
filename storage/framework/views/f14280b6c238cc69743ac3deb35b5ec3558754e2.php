	...
	<div class="row">
		...
		<div class="col-md-10 panel panel-default">
			...
			<div class="row panel-body" style="cursor: pointer;">
				...
				<h3><center>search result for <b><?php echo e($query); ?></b> are:</center></h3>
				<table>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<center> <img class="img-responsive" src="/storage/upload/<?php echo e($info->file); ?>" alt="Img Not Found"></center>
