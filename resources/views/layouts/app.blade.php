...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="text/css" href="image/df.png">
    <!-- Bootstrap -->
    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="/home"><span class="d" style="color: grey;font-weight: bolder;
               ...
               @guest
                        ...
                        @else
                            <li class="nav-item" style="">
                                ...
                                <span style="cursor: none;">Welcome</span> <span style="color: red;text-transform: uppercase;cursor: none;"> {{ Auth::user()->name }} </span> 
                                </a>
                            </li>
                            <li style="">
        ...
        <div class="container-fluid footer" style="padding-top: 50px;padding-bottom: 5px; background-color:#F8F8F8; float: bottom; ">
            <label style="float: left;">Developed By </label>
