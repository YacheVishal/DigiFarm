    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="{{route('home')}}"><span class="d" style="color: grey;font-weight: bolder;
               ...
               @guest
                        ...
                        @else
                            <li class="nav-item" style="">
                                ...
                                <span>Welcome</span> <span style="color: red;text-transform: uppercase;"> {{ Auth::user()->name }} </span> 
                                </a>
                            </li>
                            <li style="">
